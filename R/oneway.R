...
#' @description \code{oneway} computes a one way analysis of variance
...
#' @details
#' This function computes a standard one-way ANOVA, means, and
#' standard deviations. Missing values are handled via listwise
#' deletion.
#' @author Nurah Jaradat <njaradat@@wesleyan.edu>
#' @examples
